            ...
            <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg border border-gray-100 p-6">
                ...
                <div className="mb-6 max-w-sm bg-blue-50 p-4 rounded-lg border border-blue-100">
                    ...
                    <select
                        ...
                        className="block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring focus:ring-green-200 focus:ring-opacity-50 p-2 text-gray-700 font-medium"
                    >
