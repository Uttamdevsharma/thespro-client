        ...
        {researchCells && researchCells.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {researchCells.map((cell: any) => (
              <div
                key={cell._id}
                className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-6 flex flex-col items-start hover:shadow-2xl transition-all cursor-pointer group relative overflow-hidden"
              ...
              >
                ...
                <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50 mb-2 group-hover:text-green-700 transition-colors uppercase tracking-tight">{cell.title}</h2>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 flex-grow leading-relaxed">{cell.description}</p>
