    ...
    <div className="p-8 bg-gray-50 dark:bg-gray-950 min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        {defenseBoards && defenseBoards.length > 0 ? (
                    ...
                    <tr key={board._id} className="hover:bg-green-50/20 transition-all group">
                      <td className="px-8 py-6 whitespace-nowrap">
                        <div className="flex items-center">
                            ...
                            <span className="font-bold text-gray-800 dark:text-gray-100 tracking-tight">Board ID #{board.boardNumber}</span>
                        </div>
                      </td>
                      ...
                      <td className="px-8 py-6 whitespace-nowrap text-center">
                        <div className="flex flex-col items-center">
                            <div className="flex items-center text-sm font-bold text-gray-700 dark:text-gray-200 space-x-2">
                      ...
                      <td className="px-8 py-6 whitespace-nowrap text-center">
                        <div className="inline-flex items-center space-x-2 bg-gray-50 dark:bg-gray-950 px-3 py-1.5 rounded-lg border border-gray-100 dark:border-gray-800 group-hover:bg-white dark:bg-gray-900 transition-all">
                            <MapPin size={14} className="text-red-400" />
                            <span className="text-sm font-bold text-gray-600 dark:text-gray-300 group-hover:text-gray-900 dark:text-gray-50 transition-colors uppercase tracking-tight">{board.room?.name || 'N/A'}</span>
                        </div>
                      </td>
                      <td className="px-8 py-6 whitespace-nowrap text-right">
                        <div className="flex justify-end items-center space-x-4">
                            <button
                                ...
                                className="inline-flex items-center px-4 py-2 bg-white dark:bg-gray-900 text-green-600 border border-green-200 rounded-xl text-xs font-bold shadow-sm hover:bg-green-600 hover:text-white hover:border-green-600 transition-all active:scale-95"
          ...
          <div className="p-24 text-center bg-white dark:bg-gray-900 rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-700">
