...
const CommitteeDefenseBoardDetailPage = () => {
  ...
  if (!boardDetails) return <div className="p-20 text-center bg-white rounded-2xl border border-gray-100 max-w-6xl mx-auto mt-10 text-gray-400 font-bold italic">No board details found.</div>;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-5 mb-10">
            ...
            <div>
                ...
                <p className="text-sm font-medium text-gray-500 mt-1">Detailed board composition and assigned groups</p>
            </div>
        </div>

        <div className="bg-white shadow-2xl rounded-3xl p-8 mb-12 border border-blue-50 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div className="space-y-1">
                    ...
                    <p className="text-lg font-extrabold text-gray-800">{boardDetails.date ? format(new Date(boardDetails.date), 'PPP') : 'N/A'}</p>
                </div>
                <div className="space-y-1">
                    <p className="flex items-center text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-lg font-extrabold text-gray-800 uppercase tracking-tight">{boardDetails.room?.name || 'N/A'}</p>
                </div>
        ...
        <div className="flex items-center justify-between mb-6">
            ...
            <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-xs font-black">{boardDetails.groups?.length || 0} Groups Assigned</span>
        </div>
