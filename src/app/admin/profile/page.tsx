    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col">
                <h1 className="text-3xl font-extrabold text-gray-900 dark:text-gray-50 tracking-tight">Account Settings</h1>
                <p className="text-gray-500 dark:text-gray-400 mt-1 text-lg">Manage your profile and security preferences</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* Profile Information Card */}
                <div className="lg:col-span-1 space-y-6">
                    <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col items-center text-center">
                        ...
                        <div className="w-full mt-8 space-y-4 text-left">
                            <div className="bg-gray-50 dark:bg-gray-950 p-4 rounded-2xl">
                                ...
                                <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">{user?.email}</p>
                            </div>
                            <div className="bg-gray-50 dark:bg-gray-950 p-4 rounded-2xl">
                                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Department</label>
                                <p className="text-sm font-semibold text-gray-700 dark:text-gray-200">{user?.department?.name || 'Central Administration'}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2">
                    <div className="bg-white dark:bg-gray-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-800 h-full">
                        ...
                        <form onSubmit={handlePasswordUpdate} className="space-y-6 max-w-xl">
                            <div>
                                <label className="block text-sm font-bold text-gray-600 dark:text-gray-300 mb-2">Current Password</label>
                                <input 
                                    type="password"
                                    required
                                    className="w-full px-5 py-3 border border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-4 focus:ring-green-100 focus:border-[#50C878] text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-900 transition-all outline-none"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-sm font-bold text-gray-600 dark:text-gray-300 mb-2">New Password</label>
                                    <input 
                                        type="password"
                                        required
                                        className="w-full px-5 py-3 border border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-4 focus:ring-green-100 focus:border-[#50C878] text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-900 transition-all outline-none"
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-600 dark:text-gray-300 mb-2">Confirm New Password</label>
                                    <input 
                                        type="password"
                                        required
                                        className="w-full px-5 py-3 border border-gray-200 dark:border-gray-700 rounded-2xl focus:ring-4 focus:ring-green-100 focus:border-[#50C878] text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-900 transition-all outline-none"
