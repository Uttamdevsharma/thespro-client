...
const MultiSelectDropdown: React.FC<MultiSelectDropdownProps> = ({ allStudents, members, setMembers, currentUser }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <label htmlFor="members" className="block text-sm font-medium text-gray-700 dark:text-gray-200">Group Members (Select up to 2)</label>
      <div 
      ...
      >
        ...
        <svg className={`w-5 h-5 text-gray-500 dark:text-gray-400 transform transition-transform ${isOpen ? 'rotate-180' : ''}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
        </svg>
      </div>

      {isOpen && (
        <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-900 border border-gray-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
          <ul>
            {allStudents
