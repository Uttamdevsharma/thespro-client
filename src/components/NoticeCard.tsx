...
const NoticeCard: React.FC<NoticeCardProps> = ({ notice }) => {
  ...
  return (
    <div className="group h-full bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-[2rem] p-8 hover:shadow-2xl hover:shadow-blue-50 dark:hover:shadow-blue-900/20 transition-all duration-500 flex flex-col relative overflow-hidden">
      {/* Decorative accent */}
      ...
      <div className="flex items-center space-x-3 mb-6 relative">
        ...
        <div className="flex items-center text-[10px] font-black text-gray-400 dark:text-gray-500 dark:text-gray-400 uppercase tracking-widest">
      ...
      <div className="mt-8 pt-6 border-t border-gray-50 dark:border-gray-800 flex items-center justify-between relative">
        ...
        <button className="flex items-center space-x-1 text-blue-600 dark:text-blue-400 font-black text-xs hover:translate-x-1 transition-transform">
            <span>Read More</span>
